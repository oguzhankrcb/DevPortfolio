...
export default function HeroSection({ isOdd = false }: HeroSectionProps) {
  ...
  return (
    <section id="home" className={`min-h-screen flex items-center pt-20 ${isOdd ? 'bg-gray-50 dark:bg-slate-800/20' : 'bg-white dark:bg-slate-900'}`}>
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              {heroConfig.greeting} <span className="text-blue-500">{heroConfig.name}</span>
            </h1>
